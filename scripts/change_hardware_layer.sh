...
if [ "$1" == "blank" ]; then
    ...
    cp $CORE_DIR/hardware_layers/blank.cpp $BUILD_DIR/hardware_layer.cpp
    ...
    cp $CORE_DIR/hardware_layers/fischertechnik.cpp $BUILD_DIR/hardware_layer.cpp
    echo "Setting Platform"
    ...
    cp $CORE_DIR/hardware_layers/neuron.cpp $BUILD_DIR/hardware_layer.cpp
    echo "Setting Platform"
    echo linux > $PLATFORM_FILE
    ...
    cp $CORE_DIR/hardware_layers/pixtend.cpp $BUILD_DIR/hardware_layer.cpp
    echo "Setting Platform"
    echo rpi > $PLATFORM_FILE
    ...
    cp $CORE_DIR/hardware_layers/pixtend2s.cpp $BUILD_DIR/hardware_layer.cpp
    echo "Setting Platform"
    echo rpi > $PLATFORM_FILE
    ...
    cp $CORE_DIR/hardware_layers/pixtend2l.cpp $BUILD_DIR/hardware_layer.cpp
    echo "Setting Platform"
    echo rpi > $PLATFORM_FILE
    ...
    cp $CORE_DIR/hardware_layers/raspberrypi.cpp $BUILD_DIR/hardware_layer.cpp
    echo "Setting Platform"
    echo rpi > $PLATFORM_FILE
    ...
    cp $CORE_DIR/hardware_layers/raspberrypi_old.cpp $BUILD_DIR/hardware_layer.cpp
    echo "Setting Platform"
    echo rpi > $PLATFORM_FILE
    ...
    cp $CORE_DIR/hardware_layers/simulink.cpp $BUILD_DIR/hardware_layer.cpp
    echo "Setting Platform"
    echo win > $PLATFORM_FILE
    ...
    cp $CORE_DIR/hardware_layers/unipi.cpp $BUILD_DIR/hardware_layer.cpp
    echo "Setting Platform"
    echo rpi > $PLATFORM_FILE
